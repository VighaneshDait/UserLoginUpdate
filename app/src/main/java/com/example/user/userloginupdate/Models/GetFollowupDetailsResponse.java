...
public class GetFollowupDetailsResponse implements Parcelable{
    ...
    protected GetFollowupDetailsResponse(Parcel in) {
    ...
    public static final Creator<GetFollowupDetailsResponse> CREATOR = new Creator<GetFollowupDetailsResponse>() {
        @Override
        public GetFollowupDetailsResponse createFromParcel(Parcel in) {
            return new GetFollowupDetailsResponse(in);
        }

        @Override
        public GetFollowupDetailsResponse[] newArray(int size) {
            return new GetFollowupDetailsResponse[size];
        }
    };
