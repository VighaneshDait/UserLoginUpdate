...
public class EditFollowUpRequest implements Parcelable{
    ...
    protected EditFollowUpRequest(Parcel in) {
    ...
    public static final Creator<EditFollowUpRequest> CREATOR = new Creator<EditFollowUpRequest>() {
        @Override
        public EditFollowUpRequest createFromParcel(Parcel in) {
            return new EditFollowUpRequest(in);
        }

        @Override
        public EditFollowUpRequest[] newArray(int size) {
            return new EditFollowUpRequest[size];
        }
    };
