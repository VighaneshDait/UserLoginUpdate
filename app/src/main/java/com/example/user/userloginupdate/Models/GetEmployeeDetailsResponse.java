...
public class GetEmployeeDetailsResponse implements Parcelable{
     ...
     * IsDeleted : false
     * DeviceId : null
     * ReportingHead : 98c680d9-33b7-4dc4-adcf-37a1eb4b5595
    ...
    protected GetEmployeeDetailsResponse(Parcel in) {
    ...
    public static final Creator<GetEmployeeDetailsResponse> CREATOR = new Creator<GetEmployeeDetailsResponse>() {
        @Override
        public GetEmployeeDetailsResponse createFromParcel(Parcel in) {
            return new GetEmployeeDetailsResponse(in);
        }

        @Override
        public GetEmployeeDetailsResponse[] newArray(int size) {
            return new GetEmployeeDetailsResponse[size];
        }
    };
