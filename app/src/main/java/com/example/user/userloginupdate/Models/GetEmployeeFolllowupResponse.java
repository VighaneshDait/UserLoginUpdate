...
public class GetEmployeeFolllowupResponse implements Parcelable{
    ...
    protected GetEmployeeFolllowupResponse(Parcel in) {
    ...
    public static final Creator<GetEmployeeFolllowupResponse> CREATOR = new Creator<GetEmployeeFolllowupResponse>() {
        @Override
        public GetEmployeeFolllowupResponse createFromParcel(Parcel in) {
            return new GetEmployeeFolllowupResponse(in);
        }

        @Override
        public GetEmployeeFolllowupResponse[] newArray(int size) {
            return new GetEmployeeFolllowupResponse[size];
        }
    };
