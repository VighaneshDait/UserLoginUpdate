...
public class GetMyProfileResponse implements Parcelable{
    ...
    protected GetMyProfileResponse(Parcel in) {
    ...
    public static final Creator<GetMyProfileResponse> CREATOR = new Creator<GetMyProfileResponse>() {
        @Override
        public GetMyProfileResponse createFromParcel(Parcel in) {
            return new GetMyProfileResponse(in);
        }

        @Override
        public GetMyProfileResponse[] newArray(int size) {
            return new GetMyProfileResponse[size];
        }
    };
